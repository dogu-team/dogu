...
:::info PREREQUISITES
You need to have an host device added to the Device Farm. Refer to [Use host as a device](/management/organization/host#use-host-as-a-device) for instructions.
:::

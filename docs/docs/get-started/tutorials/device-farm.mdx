...
The Host can also be used as a Device. For more information, refer to the [Host Management](/management/organization/host) documentation.
...
1. Please visit the [Dogu Agent for Cloud](https://dogutech.io/downloads/dost) or [Dogu Agent for Self-hosted](https://github.com/dogu-team/dogu/releases) page and select the appropriate platform for your host to install the latest Dogu Agent program.
2. Please refer to the [Agent Installation](/device-farm/host/get-started) page for the recommended specifications of the host.
...
For detailed information about Dogu Agent and the host, please refer to the [Host](/device-farm/host/get-started) documentation.

:::

---

If you are experiencing any issues during the process of adding a host, please refer to the [Host Troubleshooting](/device-farm/host/trouble-shooting) document for assistance.
...
For iOS devices, additional configuration is required in Dogu Agent. Please refer to the [macOS Agent Installation](/device-farm/host/get-started#macos) documentation for more details.
...
For more detailed information about adding devices and related management tasks, please refer to the [Organization Device Management](/management/organization/device/device-management) documentation.
...
For more detailed information about device tags and their management within the organization, please refer to the [Organization Device Tag Management](/management/organization/device/tag-management) documentation.
...
- For device management capabilities, consult the [Device Management](/management/organization/device/device-management) documentation.
- To learn more about device tag management features, refer to the [Device Tag Management](/management/organization/device/tag-management) documentation.

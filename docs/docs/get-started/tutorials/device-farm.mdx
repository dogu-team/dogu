...
2. Please refer to the [Get started with Dost](/device-farm/host/get-started) page for the recommended specifications of the host.
...
For iOS devices, additional configuration is required in Dost. Please refer to the [macOS Dost](/device-farm/host/get-started#macos) documentation for more details.
...
- For device streaming and remote control, refer to the [Device Streaming and Remote Control](/device-farm/device/streaming-and-remote-control/about) documentation.

...
1. Please visit the [Dost for Cloud](https://dogutech.io/downloads/dost) or [Dost for Self-hosted](https://github.com/dogu-team/dogu/releases) page and select the appropriate platform for your host to install the latest Dost program.
...
For detailed information about Dost and the host, please refer to the [Host](/device-farm/host/get-started) documentation.
...
For iOS devices, additional configuration is required in Dost. Please refer to the [macOS Agent Installation](/device-farm/host/get-started#macos) documentation for more details.

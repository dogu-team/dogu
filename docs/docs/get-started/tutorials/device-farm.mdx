...
For iOS devices, additional configuration is required in Dogu Agent. Please refer to the [macOS Agent Installation](/device-farm/host/macos/installation) documentation for more details.

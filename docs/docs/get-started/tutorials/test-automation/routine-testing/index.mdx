...
- 💾 **Automatic download of project apps** for app testing.  
  Only when executed in "Dogu Route". If you want it to be available locally, please contact us.
...
Change the max parallel jobs count to `16` on your host device for the parallel execution of the Jobs.

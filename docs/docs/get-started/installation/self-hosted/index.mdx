...
( The ip to be set above is the same value as the DOGU_HOST value set by [Create docker-compose.env File](/get-started/installation/self-hosted#create-docker-composeenv-file) )
...
- Configuring Dogu Agent connection environment
  ...
  - Set the connection URL using the DOGU_HOST set in the [Create docker-compose.env File](/get-started/installation/self-hosted#create-docker-composeenv-file).
    :::note
...
Depending on the testing environment you want to proceed with, refer to the link below to build a device farm.  

- [Web Testing - Device Farm](/get-started/tutorials/web/device-farm)  
- [App Testing - Device Farm](/get-started/tutorials/mobile/device-farm)  
- [Game Testing - Device Farm](/get-started/tutorials/game/device-farm)

...
After downloading, refer to [Agent Installation](/device-farm/host/get-started#installation) for installation
...
See [Quick start - Device farm](/get-started/tutorials/device-farm)

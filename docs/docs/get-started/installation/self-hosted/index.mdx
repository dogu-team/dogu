...
:::note
Set the GITLAB_ROOT_ACCESS_TOKEN after running Dogu and getting token from [Issuing the GitLab Root Access Token](/get-started/installation/self-hosted#get-the-gitlab-root-access-token).
:::

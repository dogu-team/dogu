...
<TabItem value="linux" label="Linux/macOS(x86_64)" default>
...
2. Copy the contents from the [file(x86_64)](https://github.com/dogu-team/dogu/blob/main/docker-compose.yml) and paste them into the docker-compose.yml file.
...
1. Create an empty docker-compose.yml file.
2. Copy the contents from the [file(arm64)](https://github.com/dogu-team/dogu/blob/main/docker-compose-arm64.yml) and paste them into the docker-compose.yml file.

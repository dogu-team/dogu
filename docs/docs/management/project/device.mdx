...
For information about the features of device streaming and remote control, please refer to the [Device Streaming and Remote Control](/device-farm/device/streaming-and-remote-control/about) documentation.

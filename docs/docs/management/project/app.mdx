...
2. Click the "Upload app" button.
   ...
   />
3. Drag and drop or select the app file to upload.
4. Check to upload the app as the latest version(optional) and click the "Upload" button.
   :::tip
   Uploading the app to the latest version will add the `Latest` tag to the app version. This can be useful in Routine.
   :::
   <img

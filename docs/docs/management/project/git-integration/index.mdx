...
1. Go to the Dogu project page.
2. Check if the "Git" icon next to the project name is displayed in green color.
   <img
     src="/img/console/project/git-tag.png"
     style={{ width: 500, display: 'block' }}
   />
3. Select the routines tab and click the `+` icon.
4. Choose the GUI editor and check if the test script is loaded in the "Run test" action.
   <img

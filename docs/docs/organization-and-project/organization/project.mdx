...
Projects allow you to manage various aspects of **one software project(Application, Web, Game)**, such as test scripts, routines, device management, and project members.

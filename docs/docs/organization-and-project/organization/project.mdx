...
Projects allow you to manage various aspects of **one game project**, such as test scripts, routines, device management, and project members.
...
For detailed information about project features, refer to the [Project](../project/about) documentation.
...
:::info Sample Test Script

When you create a project, a sample test script is generated in the project repository. You can refer to the sample test script when creating your actual test projects.

You can learn how to execute tests using the sample test script in the [Quick start - Game testing](/get-started/game-test) tutorial.
...
Projects contain important data such as test results for games. Be cautious when deleting a project as it will result in data loss.

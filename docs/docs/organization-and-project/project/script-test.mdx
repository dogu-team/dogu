...
In script testing, you can inspect the game objects of an app with the Gamium Engine SDK installed. For more information on the Game UI Inspector feature, refer to the [Game UI Inspector](/host-and-device/device/streaming-and-remote-control/game-ui-inspector) document.

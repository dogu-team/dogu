...
Devices assigned to the project are assets for real game testing.
...
For information about the features of device streaming and remote control, please refer to the [Device Streaming and Remote Control](/host-and-device/device/streaming-and-remote-control/about) documentation.

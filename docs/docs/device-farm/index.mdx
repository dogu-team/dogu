...
You can find instructions on how to use the host as a device in the [Managing Host](/management/organization/host) section.
...
:::info
[Start Dogu Agent](host/get-started)  

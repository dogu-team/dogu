...
- To enter regional languages like Korean, install and set [`Gboard`](https://play.google.com/store/apps/details?id=com.google.android.inputmethod.latin&hl=en&gl=US) as the default keyboard.

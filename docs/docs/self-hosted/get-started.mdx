...
Download Dost from the [github releases](https://github.com/dogu-team/dogu/releases)

After downloading, refer to [Dost Installation](/host-and-device/host/get-started#installation) for installation

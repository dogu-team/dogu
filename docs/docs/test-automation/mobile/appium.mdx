...
- Fill in the empty values ​​in the test script.
  ...
  - organizationId:
    - When viewing the organization page, you can find it in the URL.  
      example: `https://~/dashboard/[organizationId]/`
  - projectId:
    - When viewing the project page, you can find it from the URL.  
      example: `https://~/projects/[projectId]`

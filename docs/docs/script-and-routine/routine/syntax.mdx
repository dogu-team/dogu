...
Documentation related to device tags can be found [here](/organization-and-project/organization/device/tag-management).
...
Define [Pre-defined Actions](./actions/predefined-actions/about) to be used in step.
...
Details of the actions provided by Dogu and their arguments can be found in the [Pre-defined Actions](./actions/predefined-actions/about) document.
...
Define [shell script action](./actions/run) to be executed in step.

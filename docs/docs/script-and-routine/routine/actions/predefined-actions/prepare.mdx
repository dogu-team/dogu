...
[Project Repository](/organization-and-project/project/repository) and [App](/organization-and-project/project/app) are downloaded to the [Host](/host-and-device/introduction#host-and-dost) to which the [Device](/host-and-device/device/settings) is connected.

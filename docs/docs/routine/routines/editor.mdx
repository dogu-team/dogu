...
3. Browser or app version
   - For web templates: You can choose the browser in which the job will run.
     <img
       src="/img/routine/gui-editor-browser-name.png"
       style={{ width: 600, display: 'block' }}
     />
   - For mobile apps and game templates: You can select the app version in which the job will run.
     <img

...
Integrated git repository and [App](/management/project/app) are downloaded to the [Host](/device-farm#host-and-dost) to which the [Device](/device-farm/device/settings) is connected.

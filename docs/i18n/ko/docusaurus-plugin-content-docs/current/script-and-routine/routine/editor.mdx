...
각 내용은 [앱 관리](/organization-and-project/project/app)와 [테스트 스크립트](../test-script/about) 문서를 참고하세요.
...
따라서 `Install app and run` 액션을 실행한 뒤에 `Run test` 액션을 실행해야 동작하게 됩니다. 액션에 대한 자세한 내용은 [액션](./actions/about) 문서를 참고하세요.
:::

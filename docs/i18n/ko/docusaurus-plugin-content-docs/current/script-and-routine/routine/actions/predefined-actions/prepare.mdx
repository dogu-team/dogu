...
:::info
[프로젝트 레포지토리](/organization-and-project/project/repository)와 [앱](/organization-and-project/project/app)은 [디바이스](/host-and-device/device/settings)가 연결되어 있는 [호스트](/host-and-device/introduction#host-and-dost)에 다운로드됩니다.
:::

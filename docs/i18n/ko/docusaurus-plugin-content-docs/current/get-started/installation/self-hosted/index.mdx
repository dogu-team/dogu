...
:::note
GITLAB_ROOT_ACCESS_TOKEN 값은 Dogu 실행 후 아래 [gitlab root Access Token 발급 받기](/get-started/installation/self-hosted#gitlab-root-access-token-발급-받기)에서 token을 발급받은 후 설정 해 주세요.
:::

...
진행하려는 테스팅 환경에 따라 아래 링크를 참고하여 디바이스 팜을 구축합니다.  

- [웹 테스팅 - 디바이스 팜](/get-started/tutorials/web/device-farm)  
- [앱 테스팅 - 디바이스 팜](/get-started/tutorials/mobile/device-farm)  
- [게임 테스팅 - 디바이스 팜](/get-started/tutorials/game/device-farm)

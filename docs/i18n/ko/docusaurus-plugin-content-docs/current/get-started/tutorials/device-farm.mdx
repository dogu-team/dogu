...
1. [클라우드용 Dost](https://dogutech.io/downloads/dost) 또는 [Self-hosted용 Dost](https://github.com/dogu-team/dogu/releases)페이지 에서 호스트 장비에 맞는 플랫폼을 선택해 Dost를 설치하세요.
...
iOS의 경우 Dost에서 별도의 설정 후 진행할 수 있습니다. 자세한 내용은 [macOS Agent](/device-farm/host/get-started#macos) 문서를 참고하세요.

...
이 튜토리얼에서는 디바이스 팜을 구축하는 방법을 설명합니다.
...
2. 안드로이드 또는 iOS 디바이스 1대
3. USB 허브 및 데이터 전송 케이블
...
2. 호스트 장비 권장 사양은 [Agent 설치하기](/device-farm/host/get-started) 문서를 참고하세요.
...
Dogu Agent와 호스트에 대한 자세한 내용은 [호스트](/device-farm/host/get-started) 문서를 참고하세요.
...
iOS의 경우 Dogu Agent에서 별도의 설정 후 진행할 수 있습니다. 자세한 내용은 [macOS Agent](/device-farm/host/get-started#macos) 문서를 참고하세요.

...
디바이스를 원할하게 사용하려면, [디바이스 설정](/host-and-device/device/settings) 문서를 읽고 디바이스 설정을 변경해 주세요.
...
2. 호스트 장비 권장 사양은 [Dost 시작하기](/host-and-device/host/get-started) 문서를 참고하세요.
...
Dost와 호스트에 대한 자세한 내용은 [호스트](/host-and-device/host/get-started) 문서를 참고하세요.

:::

---

호스트 추가 과정에 문제가 있나요? [호스트 트러블슈팅](/host-and-device/host/trouble-shooting) 문서를 참고해 보세요.
...
권한 기능에 대해서는 [권한 시스템](/organization-and-project/organization/permission) 문서를 참고하세요
:::

:::info 더 알아보기

디바이스 추가와 관련한 더 자세한 설명은 [조직 디바이스 관리](/organization-and-project/organization/device/device-management#디바이스-추가하기) 문서를 참고하세요.

:::

---

디바이스 추가 과정에 문제가 있나요? [디바이스 트러블슈팅](/host-and-device/device/trouble-shooting) 문서를 참고해 보세요.
...
디바이스 태그 관련 더 자세한 정보는 [조직 디바이스 태그 관리](/organization-and-project/organization/device/tag-management) 문서를 참고하세요.
...
- 디바이스 스트리밍 및 원격 제어는 [디바이스 원격 제어](/host-and-device/device/streaming-and-remote-control/about) 문서를 참고하세요.
- 디바이스 관리 기능에 대해서는 [디바이스 관리](/organization-and-project/organization/device/device-management) 문서를 참고하세요.
- 디바이스 태그 관리 기능에 대해서는 [디바이스 태그 관리](/organization-and-project/organization/device/tag-management) 문서를 참고하세요.

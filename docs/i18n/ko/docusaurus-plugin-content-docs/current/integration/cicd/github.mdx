...
#### 6. Github Action을 실행한 후 Dogu Routine에서 정상적으로 실행되는지 확인합니다.
...
:::info
Github Action을 취소하면 Dogu Routine도 취소됩니다.
:::

#### 7. Dogu Routine 실행 결과에 대한 URL은 Github Action에서도 확인할 수 있습니다.

...
- `routine-id`는 루틴 페이지에서 확인할 수 있습니다.
...
#### 6. Github Action을 실행합니다.

<img src={github_action_running} />

:::info
Github Action을 취소하면 Dogu 루틴도 취소됩니다.
:::

#### 7. Dogu 루틴이 실행되는 것을 확인합니다.

<img src={github_dogu_routine_running} />

#### 8. Dogu 루틴 실행 결과에 대한 URL은 Github Action에서도 확인할 수 있습니다.
...
- [루틴](http://localhost:3101/ko/routine/routines)

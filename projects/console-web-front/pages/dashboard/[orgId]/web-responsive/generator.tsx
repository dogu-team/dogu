...
const ResponsiveWebTestingGeneratorPage: NextPageWithLayout<OrganizationServerSideProps> = ({ user, organization }) => {
  ...
  return (
    <ResponsiveWebTestingContext.Provider value={{ selectedVendors, setSelectedVendors }}>
      ...
      <Box>
        <TitleBox>
          <H4>Select Mobile Device Vendors</H4>
          <StyledHr />
        </TitleBox>
        <Centered>
...
ResponsiveWebTestingGeneratorPage.getLayout = (page) => {
  return (
...
export default ResponsiveWebTestingGeneratorPage;

...
export const getProjectSlackRoutine = async (
...
export const updateProjectSlackRemote = async (
  organizationId: OrganizationId,
  projectId: ProjectId,
  dto: UpdateProjectSlackRemoteDtoBase,
) => {
...
export const updateProjectSlackRoutine = async (
  organizationId: OrganizationId,
  projectId: ProjectId,
  dto: UpdateProjectSlackRoutineDtoBase,
) => {
  dto.onSuccess = Number(dto.onSuccess);
  dto.onFailure = Number(dto.onFailure);

import { BillingPlanInfoBase, BillingSubscriptionGroupType } from '@dogu-private/console';
...
export type SelectedPlan = Pick<BillingPlanInfoBase, 'category' | 'option' | 'type' | 'billingPlanSourceId'>;

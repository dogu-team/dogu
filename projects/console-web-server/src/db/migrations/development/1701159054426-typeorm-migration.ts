...
export class TypeormMigration1701159054426 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "organization_scm" ("organization_scm_id" uuid NOT NULL, "organization_id" uuid NOT NULL, "type" "public"."organization_scm_type_enum" NOT NULL, "service_type" "public"."organization_scm_service_type_enum" NOT NULL, "token" character varying NOT NULL, "created_at" TIMESTAMP(3) WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(3) with time zone, "updated_at" TIMESTAMP(3) WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(3) with time zone, "deleted_at" TIMESTAMP(3) WITH TIME ZONE DEFAULT NULL, CONSTRAINT "PK_e47884a7b8fa3f6bf21998b3fa9" PRIMARY KEY ("organization_scm_id"))`,
    );
    await queryRunner.query(

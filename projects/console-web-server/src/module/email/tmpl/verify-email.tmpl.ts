...
export function getVerifyEmailTemplate(user: User, token: string): string {
  return `
<!DOCTYPE html>
          ...
          <tr>
            <td style="padding: 20px 20px 0 20px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                  <td align="center" style="padding: 40px 0 0 0; font-size: 24px; font-weight: 600;">Verify your email</td>
                </tr>
                <tr>
                  <td align="left" style="padding: 32px 0 0 0; font-size: 16px; line-height: 1.4;">
                    Dear ${user.name},
                    <br />
                    <br />
                    Thank you for signing up with Dogu. In order to ensure the security of your account and to provide you with the best possible user experience, we need to verify your email address.
                    <br />
                    <br />
                    To complete the verification process, please click on the following link in the next 7 days:
                  </td>
                </tr>
                <tr>
                  <td align="center" style="padding: 24px 0 32px 0;">
                    <a href="${process.env.DOGU_CONSOLE_URL as string}/auth/verify?email=${user.email}&token=${token}" style="

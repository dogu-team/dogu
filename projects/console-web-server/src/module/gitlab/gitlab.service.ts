...
import { OrganizationId, OrganizationRoleId, ProjectId, ProjectRoleId, TeamId, UserId } from '@dogu-private/types';
...
import { OrganizationAndUserAndOrganizationRole, OrganizationAndUserAndTeam, ProjectAndTeamAndProjectRole, User } from '../../db/entity/index';
...
export class GitlabService {
  ...
  async getGitUrlWithAuth(organizationId: OrganizationId, projectId: ProjectId) {
    ...
    const gitUrlWithoutProtocol = config.gitlab.host;

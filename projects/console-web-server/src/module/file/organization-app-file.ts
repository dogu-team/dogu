...
export type OrganizaitonAppType = 'apk' | 'ipa';

export function convertExtToOrganizationAppType(ext: string): OrganizaitonAppType | null {
  if (ext === 'apk') {
    return 'apk';
  } else if (ext === 'ipa') {
    return 'ipa';
...
export type OrganizationAppMeta = {
  [key in OrganizaitonAppType]: {
    mimeTypes: string[];
  };
};

export const organizationAppMeta: OrganizationAppMeta = {
  apk: {
...
export class OrganizationAppDirectory {
  constructor(
    public readonly organizationId: OrganizationId,
    public readonly type: OrganizaitonAppType,
  ...
  private getBasePath(): string {
    ...
    return `organizations/${this.organizationId}/${dirName}`;
  }
}

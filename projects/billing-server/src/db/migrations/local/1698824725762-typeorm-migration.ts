...
export class TypeormMigration1698824725762 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "billing_organization_and_billing_coupon" ("billing_organization_id" uuid NOT NULL, "billing_coupon_id" uuid NOT NULL, "created_at" TIMESTAMP(3) WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(3) with time zone, "updated_at" TIMESTAMP(3) WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(3) with time zone, "deleted_at" TIMESTAMP(3) WITH TIME ZONE DEFAULT NULL, CONSTRAINT "PK_a578bb8e2086cd74a06486582a1" PRIMARY KEY ("billing_organization_id", "billing_coupon_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "billing_method_nice" ("billing_method_nice_id" uuid NOT NULL, "billing_organization_id" uuid NOT NULL, "bid" character varying, "card_code" character varying, "card_name" character varying, "card_no_last_4" character varying, "subscribe_regist_response" jsonb, "created_at" TIMESTAMP(3) WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(3) with time zone, "updated_at" TIMESTAMP(3) WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(3) with time zone, "deleted_at" TIMESTAMP(3) WITH TIME ZONE DEFAULT NULL, CONSTRAINT "UQ_72a21a92aa304ec99eb11bf00ba" UNIQUE ("billing_organization_id"), CONSTRAINT "REL_72a21a92aa304ec99eb11bf00b" UNIQUE ("billing_organization_id"), CONSTRAINT "PK_2a604a826dc51af43eebfcb67f7" PRIMARY KEY ("billing_method_nice_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "billing_method_nice" ADD CONSTRAINT "FK_72a21a92aa304ec99eb11bf00ba" FOREIGN KEY ("billing_organization_id") REFERENCES "billing_organization"("billing_organization_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "billing_subscription_plan" ADD CONSTRAINT "FK_e47c7377373e996838e863a44fa" FOREIGN KEY ("billing_organization_id") REFERENCES "billing_organization"("billing_organization_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "billing_history" ADD CONSTRAINT "FK_5d2a63af01a4c3c4c963778dd65" FOREIGN KEY ("billing_organization_id") REFERENCES "billing_organization"("billing_organization_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(

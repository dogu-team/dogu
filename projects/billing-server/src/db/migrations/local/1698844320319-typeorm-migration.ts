...
export class TypeormMigration1698844320319 implements MigrationInterface {
  name = 'TypeormMigration1698844320319';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "billing_coupon" ADD "type" "public"."billing_coupon_type_enum" NOT NULL DEFAULT 'basic'`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "billing_history_and_billing_subscription_plan" DROP COLUMN "updated_at"`);
    await queryRunner.query(`ALTER TABLE "billing_history_and_billing_subscription_plan" DROP COLUMN "created_at"`);
    await queryRunner.query(`ALTER TABLE "billing_coupon" DROP COLUMN "type"`);

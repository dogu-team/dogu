...
export class TypeormMigration1702382258479 implements MigrationInterface {
  name = 'TypeormMigration1702382258479';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "billing_method_paddle" DROP COLUMN "customerId"`);
    await queryRunner.query(`ALTER TABLE "billing_method_paddle" ADD "customerId" text NOT NULL`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "billing_method_paddle" DROP COLUMN "customerId"`);
    await queryRunner.query(`ALTER TABLE "billing_method_paddle" ADD "customerId" character varying`);

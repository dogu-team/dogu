...
//        Logger.v("ControlAPIHandler.process seq:" + param.seq +  ", msg:"  + controlMessage.toString())
    ...
    override fun process(appContext: AppContext, param: DcDa.DcDaParam): DcDa.DcDaReturn.Builder {
        ...
        var errorResult = this.processInternal(appContext, controlMessage)
        val controlRet =
            com.dogu.protocol.generated.inner.types.DcDa.DcDaControlReturn.newBuilder().build()
        return DcDa.DcDaReturn.newBuilder().setDcDaControlReturn(controlRet)
    }

    fun processInternal(
        appContext: AppContext,
        controlMessage: DeviceControlOuterClass.DeviceControl
    ): com.dogu.protocol.generated.outer.Errors.ErrorResult {
        var errorResult = com.dogu.protocol.generated.outer.Errors.ErrorResult.newBuilder()
            .setCode(com.dogu.protocol.generated.outer.Errors.Code.CODE_SUCCESS_COMMON_BEGIN_UNSPECIFIED)
            .setMessage("").build()
        try {
            if (device == null) {
                device = Device(appContext.options);
            ...
            Logger.e(
                "ControlAPIHandler.process error: " +
            ...
            errorResult = com.dogu.protocol.generated.outer.Errors.ErrorResult.newBuilder()
                .setCode(com.dogu.protocol.generated.outer.Errors.Code.CODE_ANDROID_DEVICE_AGENT_INPUT_UNKNOWN)
                .setMessage("msg: " + e.message + ", stack: " + e.stackTraceToString()).build()
        }
        return errorResult
    }
}

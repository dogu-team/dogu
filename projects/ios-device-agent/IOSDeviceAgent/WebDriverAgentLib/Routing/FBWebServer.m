...
- (NSString*) url
{
  return [NSString stringWithFormat:@"http://%@:%d", [XCUIDevice sharedDevice].fb_wifiIPAddress ?: @"localhost", [self.server port]];
}
...
- (void)startHTTPServer
{
  ...
  [FBLogger logFmt:@"%@%@%@", FBServerURLBeginMarker, self.url, FBServerURLEndMarker];
}

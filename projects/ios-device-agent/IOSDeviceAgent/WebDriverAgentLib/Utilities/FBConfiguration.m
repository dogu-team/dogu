...
+ (NSRange)bindingPortRange
{
  ...
  // Existence of DOGU_IOS_DEVICE_AGENT_WEB_DRIVER_PORT in the environment implies the port range is managed by the launching process.
  if (NSProcessInfo.processInfo.environment[@"DOGU_IOS_DEVICE_AGENT_WEB_DRIVER_PORT"] &&
      [NSProcessInfo.processInfo.environment[@"DOGU_IOS_DEVICE_AGENT_WEB_DRIVER_PORT"] length] > 0) {
    return NSMakeRange([NSProcessInfo.processInfo.environment[@"DOGU_IOS_DEVICE_AGENT_WEB_DRIVER_PORT"] integerValue] , 1);
  }

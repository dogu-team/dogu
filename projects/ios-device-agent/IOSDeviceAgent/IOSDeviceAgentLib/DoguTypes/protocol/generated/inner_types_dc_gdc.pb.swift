...
public struct Inner_Types_DcGdcGetSurfaceStatusParam {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Inner_Types_DcGdcGetSurfaceStatusResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var hasSurface_p: Bool = false

  public var isPlaying: Bool = false

  public var lastFrameDeltaMillisec: UInt32 = 0
...
extension Inner_Types_DcGdcGetSurfaceStatusParam: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DcGdcGetSurfaceStatusParam"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "serial"),
    2: .standard(proto: "screen_id"),
    3: .same(proto: "pid"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.serial) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self._screenID) }()
  ...
  public static func ==(lhs: Inner_Types_DcGdcGetSurfaceStatusParam, rhs: Inner_Types_DcGdcGetSurfaceStatusParam) -> Bool {
    if lhs.serial != rhs.serial {return false}
...
extension Inner_Types_DcGdcGetSurfaceStatusResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DcGdcGetSurfaceStatusResult"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "has_surface"),
    2: .standard(proto: "is_playing"),
    3: .standard(proto: "last_frame_delta_millisec"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBoolField(value: &self.hasSurface_p) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.isPlaying) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.lastFrameDeltaMillisec) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.hasSurface_p != false {
      try visitor.visitSingularBoolField(value: self.hasSurface_p, fieldNumber: 1)
    }
    if self.isPlaying != false {
      try visitor.visitSingularBoolField(value: self.isPlaying, fieldNumber: 2)
    }
    if self.lastFrameDeltaMillisec != 0 {
      try visitor.visitSingularUInt32Field(value: self.lastFrameDeltaMillisec, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Inner_Types_DcGdcGetSurfaceStatusResult, rhs: Inner_Types_DcGdcGetSurfaceStatusResult) -> Bool {

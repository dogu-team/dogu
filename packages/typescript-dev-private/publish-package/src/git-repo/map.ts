...
export const PackageGithubMap: PackageGithubMap = {
  ...
  '@dogu-actions/checkout': {
    development: `https://oneofthezombies:${process.env.DOGU_ACTIONS_PUBLISH_TOKEN}@github.com/dogu-actions/checkout.git`,
    production: `https://oneofthezombies:${process.env.DOGU_ACTIONS_PUBLISH_TOKEN}@github.com/dogu-actions/checkout.git`,
  },

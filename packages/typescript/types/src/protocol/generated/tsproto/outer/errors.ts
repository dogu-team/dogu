...
export enum Code {
  ...
  CODE_DEVICE_SERVER_APPIUM_CHANNEL_NOT_FOUND = 3401,
  CODE_DEVICE_SERVER_GAMIUM_CONTEXT_NOT_FOUND = 3402,
  CODE_DEVICE_SERVER_APPIUM_CHANNEL_INFO_NOT_FOUND = 3403,
...
export function codeFromJSON(object: any): Code {
  switch (object) {
    ...
    case 3401:
    case 'CODE_DEVICE_SERVER_APPIUM_CHANNEL_NOT_FOUND':
      return Code.CODE_DEVICE_SERVER_APPIUM_CHANNEL_NOT_FOUND;
    case 3402:
    case 'CODE_DEVICE_SERVER_GAMIUM_CONTEXT_NOT_FOUND':
      return Code.CODE_DEVICE_SERVER_GAMIUM_CONTEXT_NOT_FOUND;
    case 3403:
    case 'CODE_DEVICE_SERVER_APPIUM_CHANNEL_INFO_NOT_FOUND':
      return Code.CODE_DEVICE_SERVER_APPIUM_CHANNEL_INFO_NOT_FOUND;
    case 3999:
...
export function codeToJSON(object: Code): string {
  switch (object) {
    ...
    case Code.CODE_DEVICE_SERVER_APPIUM_CHANNEL_NOT_FOUND:
      return 'CODE_DEVICE_SERVER_APPIUM_CHANNEL_NOT_FOUND';
    case Code.CODE_DEVICE_SERVER_GAMIUM_CONTEXT_NOT_FOUND:
      return 'CODE_DEVICE_SERVER_GAMIUM_CONTEXT_NOT_FOUND';
    case Code.CODE_DEVICE_SERVER_APPIUM_CHANNEL_INFO_NOT_FOUND:
      return 'CODE_DEVICE_SERVER_APPIUM_CHANNEL_INFO_NOT_FOUND';

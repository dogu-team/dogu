...
export class DeviceHeartbeater {
  constructor(private readonly deviceRegistry: DeviceRegistry, private readonly consoleClientService: ConsoleClientService, private readonly logger: DoguLogger) {}

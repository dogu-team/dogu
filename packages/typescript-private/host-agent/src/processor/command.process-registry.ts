  ...
  async command(command: string, args: string[], options: SpawnOptions, context: MessageContext): Promise<ErrorResult> {
    ...
    return new Promise((resolve, reject) => {
      (async (): Promise<void> => {
        ...
        this.logger.verbose(`envvvv 3 `, environmentVariableReplacer.stackProvider.export(this.logger));
        if (childEnv) {
          ...
          this.logger.verbose(`envvvv 4 `, environmentVariableReplacer.stackProvider.export(this.logger));
        }
        ...
        this.logger.verbose(`envvvv 5 `, environmentVariableReplacer.stackProvider.export(this.logger));

...
export const DeveloperOptionsString: {
  ...
  tl: 'Mga opsyon ng developer',
  lt: 'Kūrėjo parinktys',
  zu: 'Izinketho Zonjiniyela',
  eu: 'Garatzaileentzako aukerak',
  ko: '개발자 옵션',
  sk: 'Pre vývojárov',
  es: 'Opciones para desarrolladores',
  ...
  fr: 'Options pour les développeurs',
  hu: 'Fejlesztői beállítások',
  vi: 'Tùy chọn cho nhà phát triển',
  ja: '開発者向け​オプション',
  iw: 'אפשרויות למפתחים',
  ...
  'my-MM': 'ဆော့ဝဲလ်ရေးသူ ရွေးစရာမျာ',
  zh: '开发者选项',
  'zh-Hans': '开发者选项',
  'zh-Hant': '開發人員選項',
  ...
  'fr-CA': 'Options pour les développeurs',

...
def click_documentation_link(page: Page):
    with page.context.expect_page() as new_page_info:
        page.click('xpath=//*[@id="__next"]/section/section/header/div/div/div[1]/div/div/span[3]/a')
...
def click_community_link(page: Page):
    with page.context.expect_page() as new_page_info:
        page.click('xpath=//*[@id="__next"]/section/section/header/div/div/div[1]/div/div/span[4]/a')
    return new_page_info.value
...
def click_github_link(page: Page):
    with page.context.expect_page() as new_page_info:
        page.click('xpath=//*[@id="__next"]/section/section/header/div/div/div[2]/iframe')
    return new_page_info.value
